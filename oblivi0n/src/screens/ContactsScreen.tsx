        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Secure anonymous messaging with PIN-based contacts
            </Text>
          </View>
          ...
          >
            <View style={styles.cardContent}>
              ...
              <View style={styles.cardTextContainer}>
                ...
                <Text style={styles.cardSubtitle}>
                  Send a contact request using someone's 2-digit PIN
                </Text>
              </View>
              <Text style={styles.chevron}>›</Text>
            </View>
          ...
          <View style={styles.infoSection}>
            ...
            <View style={[styles.infoCard, styles.glassCard]}>
              <View style={styles.infoContent}>
                ...
                <View style={styles.infoTextContainer}>
                  <Text style={styles.infoTitle}>Anonymous PIN System</Text>
                  <Text style={styles.infoText}>
                    WYSPR uses secure 2-digit PINs for contact identification. No personal information is shared.
                  </Text>
                </View>
              </View>
            </View>
